...
im1 = m.plot(xpts_all[0] , ypts_all[0], 
	color = colors[-2], linewidth=0.5, zorder=4)
im2 = m.plot(xpts_all[1] , ypts_all[1], 
...
leg = ax1.legend(plts, varnames, 
	loc=1, ncol=1,columnspacing=0.8, labelspacing=0.5,handletextpad=0.1, borderaxespad=0.05,bbox_to_anchor=(1.15, 0.93), frameon=False)
...
savefig(figpath+'FlinesArcticSeasons.png', dpi=300)
close(fig)
