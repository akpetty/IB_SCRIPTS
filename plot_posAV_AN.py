...
textwidth=5.
fig = figure(figsize=(textwidth,(textwidth*(3./2.)*aspect)+1.3))
subplots_adjust(left = 0.01, right = 0.99, bottom=0.01, top = 0.99, wspace = 0.01, hspace=0.02)
for i in xrange(num_years):
	...
	vars()['ax'+str(i)].annotate(str(i+2009), xy=(0.03, 0.95), xycoords='axes fraction', horizontalalignment='left', verticalalignment='top', zorder=10)
