...
leg = ax1.legend(plts, varnames, 
	loc=1, ncol=1,columnspacing=0.8, 
    labelspacing=0.5,handletextpad=0.1, borderaxespad=0.05,bbox_to_anchor=(0.92, 0.3), frameon=False)
...
savefig(figpath+'FlinesArcticFallBscat.png', dpi=300)
close(fig)
